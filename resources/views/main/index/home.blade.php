            ...
            <div data-genre="{{ $category->id }}" class="category__slider col-xs-12 m-t-20">
                <div class="category__slider-title row">
                    <div class="col-xs-12">
                        <h3>
                            <a href="#"
                               onclick="alert('Here will be link');return false;">{{ $category->category_name }}</a>
                        </h3>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        @foreach ($films as $film)
                            <div class="video__item col-xs-4 col-sm-4 col-md-3 col-lg-1">
                                <a href="{{ route('video-page', ['id' => $film->id, 'name' => $film->getSlug()]) }}"
                                   class="col-item">
                                    <div class="photo">
                                        <img src="{{ $film->logo_url or 'http://placehold.it/320x260.png' }}"
